...
namespace RegistryParser.Cells;
            ...
            else
            {
                ...
                if (_dataLengthInternal > 16344 && _minorVersion > 3)
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        Debug.WriteLine($"ERROR: Error getting data block: {e.Message}");
                    }
    ...
    public object ValueData
    {
        get
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Debug.WriteLine(
                        $"ERROR: Error getting ValueData for {ValueName}. Error message: {ex.Message}");
                    val = localDbl;
                    //throw;
                }
            }
